        ...
        <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                ...
                <div data-aos = "zoom-in">
                    ...
                    className='max-w-[400px] h-[350px] w-full mt-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover'
                    />
                </div>
                {/* Content Section */}
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    >Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deleniti, ipsa possimus facilis iure vitae inventore fuga dolorem voluptate ut in id, molestiae vero architecto iusto.</p>
